 ...
 * <ul>
 * <li><code>processInputEvent(EventA event)</code></li> 
 * <li><code>processInputEvent(EventB event)</code></li>
 * </ul>
 * </p>
 * <p>Then:
 * <ul>
 * <li>When event1 of type <code>EventA extends Event</code> is received on this PE, it will be handled by method <code>processInputEvent(EventA event)</code></li>
 * <li>When event2 of type <code>EventB extends EventA</code> is received on this PE, it will be handled by method <code>processInputEvent(EventB event)</code></li>
 * </ul>
 * </p>
 * <p>
...
public interface OverloadDispatcher {
    ...
    public void dispatchInputEvent(ProcessingElement pe, Event event);

    public void dispatchOutputEvent(ProcessingElement pe, Event event);
}
